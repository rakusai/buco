========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : Buco
========================================================================


AppWizard が生成した Buco には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには Buco を構成している各ファイルの概要説明が含まれています。
...
Buco.h
    ...
    みます） をインクルードし、また CBucoApp アプリケーションクラスを宣
    言します。

Buco.cpp
    このファイルは CBucoApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\Buco.ico
    ...
    ルです。このアイコンはリソース ファイル Buco.rc によってインクルード
    されます。
...
BucoDlg.h, BucoDlg.cpp - ダイアログ
    これらのファイルは CBucoDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な Buco.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) Buco.pch 
